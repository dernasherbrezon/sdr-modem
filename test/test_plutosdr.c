...
void test_exceeded_rx_input() {
  ...
  TEST_ASSERT_EQUAL_INT(0, actual_len);
}
...
void test_invalid_scan_context() {
  init_rx_data(10, 10);
...
void test_unable_create_buffer() {
  init_rx_data(10, 10);
...
void test_invalid_find_channel() {
  init_rx_data(10, 10);
...
void test_unable_to_write_value() {
  init_rx_data(10, 10);
...
int main(void) {
  ...
  RUN_TEST(test_exceeded_rx_input);
  RUN_TEST(test_tx);
  RUN_TEST(test_no_tx_config);
  RUN_TEST(test_invalid_scan_context);
  ...
  RUN_TEST(test_invalid_rx_config);
  RUN_TEST(test_unable_to_write_value);
  return UNITY_END();
}
