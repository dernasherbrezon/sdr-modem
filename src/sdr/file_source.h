...
int file_source_create(uint32_t id, const char *rx_filename, const char *tx_filename, uint64_t sample_rate, uint32_t max_output_buffer_length, sdr_device **result);
